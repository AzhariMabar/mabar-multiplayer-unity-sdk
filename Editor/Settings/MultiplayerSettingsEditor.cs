    ...
    public class MultiplayerSettingsEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Validate Settings", GUILayout.Height(28)))
            {
                ...
                else if (string.IsNullOrEmpty(settings.ApiUrl) || string.IsNullOrEmpty(settings.WsUrl))
                    EditorUtility.DisplayDialog("Mabar SDK", "ApiUrl and WsUrl are required.", "OK");
                else
